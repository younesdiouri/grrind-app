...
## Plan et tâches
- [ ] Contrat backend : statistiques résolues et inventaire public protégé par le voter existant.
- [ ] Génération du contrat depuis la branche backend, sans édition manuelle.
- [ ] Navigation Inventaire/Santé, présentation commune, profils, illustrations des adversaires.
- [ ] Tests et previews RN, QA iOS Metro avant/après et captures inspectées.
- [ ] Barrières finales, commits liés, branches poussées et PRs ouvertes, sans fusion.
